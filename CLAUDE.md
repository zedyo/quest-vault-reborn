...
## Aktuelle Version: 1.1.15 (2026-06-14)
...
- [~] Overlord-Klassen + Karten: Grundspiel ✅ (1.1.15 – Basis-Deck + Magus/Saboteur/Kriegsherr +
      Universal, 28 Karten zweisprachig aus any2cards `overlord-decks.js`; `overlordClasses.ts` +
      `OverlordPage.tsx` Route `/overlord` + Tests + overlord-classes.md). Offen: Erweiterungs-Klassen
      (Basis II, Punisher, Infector, Enchanter, Unkindness, Shadowmancer, Soulbinder, Universal-Erw.)
      + Belohnungskarten (Overlord/Quest/Rumor Reward)
