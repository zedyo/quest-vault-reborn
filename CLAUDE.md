...
## Aktuelle Version: 1.1.24 (2026-06-15)
...
- [~] Plotdeck-Karten: Grundspiel komplett + Erweiterungs-Batch 1 ✅ (1.1.22/23 Grundspiel 6 Decks +
      1.1.24 Erweiterungen Dragon's Greed/Raging Infection/Dark Illusions → **9 Decks / 90 Karten** aus
      any2cards `plot-decks.js`, EN 1:1 verifiziert; `PlotCard`/`PlotDeck`-Typen, `plotDecks.ts`
      Generator-erzeugt + `PlotDecksPage.tsx` Route `/plotdecks` + Tests). Offen: 11 Erweiterungs-Plotdecks
      (110 Karten) + die 4 Agenten validieren
