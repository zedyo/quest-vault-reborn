...
## Aktuelle Version: 1.1.25 (2026-06-15)
...
- [~] Plotdeck-Karten: Grundspiel + Lindwurm + Trollsümpfe + Labyrinth ✅ (1.1.22–1.1.25 →
      **12 Decks / 120 Karten** aus any2cards `plot-decks.js`, EN 1:1 verifiziert; Karten-ID = `deckId-xws`,
      da xws „feralinstincts" in 2 Decks vorkommt; `PlotCard`/`PlotDeck`-Typen, `plotDecks.ts`
      Generator-erzeugt + `PlotDecksPage.tsx` Route `/plotdecks` + Tests). Offen: 8 Erweiterungs-Plotdecks
      (80 Karten: Rabenfels, Bilehall, Nerekhall) + die 4 Agenten validieren
