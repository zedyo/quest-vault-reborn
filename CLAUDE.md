...
## Aktuelle Version: 1.1.23 (2026-06-14)
...
- [~] Plotdeck-Karten: Grundspiel komplett ✅ (1.1.22 Batch 1 + 1.1.23 Batch 2 – 6 Decks/60 Karten
      aus any2cards `plot-decks.js`, EN 1:1 verifiziert; `PlotCard`/`PlotDeck`-Typen, `plotDecks.ts`
      Generator-erzeugt + `PlotDecksPage.tsx` Route `/plotdecks` + Tests). Offen: Erweiterungs-Plotdecks
      (14 Decks / ~141 Karten) + die 4 Agenten validieren
