...
// Reise-Geländetypen (any2cards, EN) → deutsche Kurzlabels.
...
function rumorImg(r: Rumor): string {
  return import.meta.env.BASE_URL + r.imageDe
}
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="sm:w-64 flex-shrink-0 mx-auto">
          <img src={rumorImg(rumor)} alt={rumor.nameDe} className="w-full rounded border border-dungeon-700" />
        </div>
        <div className="flex-1 space-y-2 text-sm min-w-0">
          ...
          <p className="text-xs text-gray-500 pt-1">
            ...
            wiedergegeben – die Werte sind dem Kartenbild zu entnehmen.
          </p>
        </div>
      </div>
    </ModalOverlay>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">
          {filtered.length} Gerücht-Karten {onlyOwned ? 'in deiner Sammlung' : 'insgesamt'} · deutsche Kartenbilder
        </p>
      </div>
