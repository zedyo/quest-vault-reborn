  ...
  // ─── Basis-Deck (immer im Spiel, unabhängig von der gewählten Klasse) ───────
  {
    ...
    cards: [
      ...
      },
      {
        ...
        rulesDe: "Spiele diese Karte, wenn ein Held ein leeres Feld betritt. Der Held legt eine Wahrnehmung-Probe ab. Wenn sie misslingt, erleidet er 1 Herz und verliert 1 Bewegungspunkt. Wenn er keine Bewegungspunkte mehr hat, die er verlieren könnte (z. B. wenn er sich mithilfe von Erschöpfung bewegt hat), ist er betäubt.",
      ...
      },
      {
        ...
        rulesDe: "Spiele diese Karte, nachdem ein Held eine Tür öffnet oder sucht. Er legt eine Wahrnehmung- oder Stärke-Probe ab (nach deiner Wahl). Wenn sie gelingt, ziehst du eine Overlordkarte. Wenn sie misslingt, erleidet er 1 Herz und 1 Erschöpfung und wird vergiftet.",
      ...
      },
      {
        ...
        rulesDe: "Spiele diese Karte, wenn ein Held in einer Bewegungsaktion ein leeres Feld betritt. Der Held legt eine Wahrnehmung-Probe ab. Wenn sie misslingt, endet seine Bewegungsaktion sofort (er kann aber weiterhin Erschöpfung erleiden, um sich zu bewegen oder noch eine Bewegungsaktion ausführen, falls er noch Aktionen übrig hat).",
  ...
  // ─── Klasse: Verzauberer (Enchanter) – Schloss Rabenfels ────────────────────
  {
    ...
    cards: [
      ...
      },
      {
        ...
        rulesDe: "Spiele diese Karte in deinem Zug auf 1 Monstergruppe. Diese Karte bleibt im Spiel. Jedes Monster dieser Gruppe kann nach einem eigenen Angriff um 1 Feld bewegen. Wirf diese Karte sofort ab, wenn ein Monster dieser Gruppe sich in seiner Aktivierung nicht mindestens um 1 Feld bewegt.",
      ...
      },
      {
        ...
        rulesDe: "Spiele diese Karte in deinem Zug auf 1 Monstergruppe. Diese Karte bleibt im Spiel. Jedes Mal, wenn eine Verzauberer-Karte von einer anderen Monstergruppe abgeworfen wird, spiele sie auf dieser Gruppe. Die Karte bleibt im Spiel. Ziehe dann 1 Overlordkarte.",
